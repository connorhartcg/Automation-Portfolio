...
app.layout = html.Div([
    ...
    # --- MENU BAR ---
    html.Div([
        dbc.Button("Drawer Flower", id="menu-drawer-btn", color="secondary", outline=True, style={"marginRight": "12px", "color": "#e0e0e0", "border": "2px solid #fff", "backgroundColor": "rgba(40,40,40,0.3)", "transition": "background 0.2s, color 0.2s, border 0.2s"}, className="menu-btn"),
        dbc.Button("Restock List", id="menu-restock-btn", color="secondary", outline=True, style={"marginRight": "12px", "color": "#e0e0e0", "border": "2px solid #fff", "backgroundColor": "rgba(40,40,40,0.3)", "transition": "background 0.2s, color 0.2s, border 0.2s"}, className="menu-btn"),
        dbc.Button("Not On Floor", id="menu-nof-btn", color="secondary", outline=True, style={"color": "#e0e0e0", "border": "2px solid #fff", "backgroundColor": "rgba(40,40,40,0.3)", "transition": "background 0.2s, color 0.2s, border 0.2s"}, className="menu-btn")
